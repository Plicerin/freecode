...
- [ ] **Phase 2 — the measurement loop** (the honest differentiator): each learned artifact carries a scorecard (times fired, turns/corrections saved, verify-first-try rate) sourced from the activity log + verify gate; surfaces "this rule saved you ~3 corrections across 4 uses," and **decays** artifacts that never fire or don't help.
